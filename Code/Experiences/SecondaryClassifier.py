...
from keras.layers import recurrent, RepeatVector, Activation, TimeDistributed, Dense, Dropout, Flatten
...
model.load_weights("SecondaryRec.h5")
...
model.save_weights("SecondaryRec.h5", overwrite=True)
