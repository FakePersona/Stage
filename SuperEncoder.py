...
from keras.layers import recurrent, RepeatVector, embeddings, Activation, TimeDistributed, Dense, Convolution1D, Flatten
...
#Convolutional recursive encoder

model.add((recurrent.LSTM(ACIDS, input_shape=(10, ACIDS), return_sequences=True)))
